...
public interface PowerPointService {
     ...
     * @throws SlideShowTemplate.LoadException if the template is invalid.
     */
     ...
     * @throws SlideShowTemplate.LoadException if the template is invalid.
     */
    XMLSlideShow topicmap(TopicMapData topicmap) throws SlideShowTemplate.LoadException;
     ...
     * @throws SlideShowTemplate.LoadException if the template is invalid.
     */
    XMLSlideShow sunburst(SunburstData sunburst) throws SlideShowTemplate.LoadException;
